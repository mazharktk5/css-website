...
export async function POST() {
    try {
        ...
        if (eventCount === 0) {
            const eventsData = [
                { title: "Cybersecurity Seminar", date: "2025-09-25", time: "2:00 PM - 5:00 PM", location: "Computer Lab A", image: "/images/events/CyberBootcamp.png", description: "Join us for an engaging seminar on cybersecurity best practices and emerging threats.", tags: ["Cybersecurity", "Seminar"], registrationLink: "#", category: "AI" },
                { title: "Debate Competition", date: "2025-11-20", time: "9:00 AM - 11:00 AM", location: "Engineering Building", image: "/images/events/DebateCompetition.png", description: "Showcase your debating skills in our annual competition with exciting prizes for the winners.", tags: ["Competition", "Debate"], registrationLink: "#", category: "Web Development" },
