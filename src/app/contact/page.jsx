...
export default function ContactPage() {
  ...
  return (
    <section className="relative bg-white text-gray-900 overflow-hidden min-h-screen pt-24 pb-24 md:pb-32">
      {/* Background Decor */}
      <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none" 
           style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%233e76b2' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")` }} 
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="mt-6 text-gray-500 font-medium text-sm border-l-2 border-[#3e76b2] pl-4">
            Have a question? Our team usually responds within 24 hours.
          </p>
        </motion.div>
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <button 
                    ...
                    className="px-8 py-3 bg-white text-[#3e76b2] rounded-xl font-bold uppercase text-xs tracking-widest hover:bg-blue-50 transition-colors"
                  >
                    Send Another
                  </button>
                </motion.div>
...
function InfoCard({ title, value, icon }) {
  return (
    <div className="flex items-start gap-6 group">
      <div className="w-12 h-12 bg-blue-50 flex items-center justify-center rounded-xl text-[#3e76b2] group-hover:bg-[#3e76b2] group-hover:text-white transition-all duration-300">
        {icon}
      </div>
      <div>
