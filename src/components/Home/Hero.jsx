...
export default function Hero() {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('/images/gallery/heroback.png')" }} 
    >
      
      <div className="absolute inset-0 bg-white/50 backdrop-blur-[2px] z-0"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 items-center gap-12 w-full py-20 lg:min-h-[90vh]">
        ...
        >
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] text-blue-950">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-5">
            <Link
              href="#events"
              className="px-8 py-4 bg-blue-400 text-white rounded-2xl font-semibold hover:bg-blue-500 hover:-translate-y-1 transition-all shadow-xl shadow-blue-200"
            >
              Explore Events
            </Link>
            <Link
              href="/contact"
              className="px-8 py-4 border-2 border-blue-400 text-blue-900 rounded-2xl font-semibold hover:bg-blue-50 hover:-translate-y-1 transition-all"
            >
              Join Our Community
            </Link>
          </div>
        ...
        <motion.div
          ...
          className="relative w-full h-[350px] sm:h-[450px] lg:h-[550px] flex justify-center"
        >
